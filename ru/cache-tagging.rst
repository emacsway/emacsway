...
Под блокировкой меток понимается предотвращение создание кэша, помеченного заблокированной меткой, а не блокирование потока, пытающегося создать кэш с заблокированной меткой (при желании, реализацию блокировки можно легко подменить).
