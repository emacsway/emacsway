...
# emacsway build configuration file, created by
# `ablog start` on Wed Oct  7 18:30:02 2015.
#
...
blog_baseurl = u'https://{0}/'.format(os.environ.get('HOST', 'emacsway.bitbucket.io'))
